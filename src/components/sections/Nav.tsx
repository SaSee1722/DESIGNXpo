      ...
      >
        ...
        <div className="flex items-center gap-10">
          ...
          <div className="flex items-center gap-5">
            ...
            <Link 
              to="/register"
              className={`hidden sm:flex px-8 py-3 ${isRegistrationClosed ? 'bg-slate-100 text-slate-400 cursor-not-allowed' : 'bg-slate-900 text-white hover:bg-indigo-600 hover:scale-105 active:scale-95'} rounded-full text-[10px] font-black uppercase tracking-[0.2em] shadow-xl transition-all duration-300 group`}
            >
              {isRegistrationClosed ? 'Closed' : 'Sign Up'} <ChevronRight className="w-3 h-3 ml-2 group-hover:translate-x-1 transition-transform" />
            </Link>
            ...
            >
              ...
              <div className="mt-6 pt-6 border-t border-slate-100 flex items-center justify-between">
                ...
                <button 
                  ...
                  className={`px-6 py-2 ${isRegistrationClosed ? 'bg-slate-100 text-slate-400 cursor-not-allowed' : 'bg-slate-900 text-white hover:bg-slate-800'} rounded-xl text-xs font-bold transition-all shadow-lg shadow-slate-900/10`}
                >
                  {isRegistrationClosed ? 'Registration Closed' : 'Join Challenge'}
                </button>
              </div>
            </motion.div>
          </motion.div>
