  ...
  >
    <div className="relative h-[450px] w-full overflow-hidden rounded-2xl">
      ...
      <div className="absolute bottom-0 left-0 p-8 w-full translate-y-4 group-hover:translate-y-0 transition-transform duration-300">
        ...
        <p className="text-sky-400 font-medium tracking-wider text-sm uppercase mb-4">{role}</p>
        <div className="h-0.5 w-0 group-hover:w-12 bg-sky-500 transition-all duration-300" />
      </div>
    </div>
  </motion.div>
);
    ...
    <section id="visionaries" className="py-24 bg-slate-50 relative overflow-hidden">
      <div className="container mx-auto px-6 relative z-10">
        <div className="max-w-3xl mb-16">
          ...
          >
            The Minds Shaping the <span className="text-sky-600">Future</span>
          </motion.h2>
      ...
      <div className="absolute top-1/2 left-0 -translate-y-1/2 w-64 h-64 bg-sky-200/20 rounded-full blur-3xl -z-10" />
