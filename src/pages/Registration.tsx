        ...
        return (
            <div className="min-h-screen bg-slate-50 flex items-center justify-center p-6 font-inter">
                ...
                >
                    ...
                    <h2 className="text-3xl font-black text-slate-900 mb-4 tracking-tight uppercase italic">Registration Successful!</h2>
                    <p className="text-slate-500 mb-8 leading-relaxed">
                        Your registration has been confirmed. Please join our official community group to stay updated.
                    </p>
                    <a 
                        href="https://chat.whatsapp.com/HqTvGrIw71KEaJoLxB0LgD" 
                        target="_blank" 
                        rel="noopener noreferrer"
                        className="flex items-center justify-center gap-3 w-full py-4 bg-[#25D366] hover:bg-[#20ba59] text-white font-black uppercase tracking-widest rounded-2xl transition-all shadow-lg shadow-[#25D366]/20 group"
                    >
                        Join WhatsApp Group
                                    ...
                                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                        <div className="relative group">
                                            ...
                                            <input 
                                                ...
                                                className="w-full bg-white border border-slate-200 focus:border-indigo-500 focus:ring-4 focus:ring-indigo-500/5 rounded-2xl py-4 pl-12 pr-4 text-slate-900 placeholder:text-slate-400 outline-none transition-all shadow-sm text-sm"
                                            />
                                        </div>
                                        <div className="relative group">
                            ...
                            <div className="space-y-6">
                                <div className="space-y-2">
                                    ...
                                    <input 
                                        ...
                                        className="w-full bg-slate-50 border border-slate-200 focus:border-indigo-500 focus:ring-4 focus:ring-indigo-500/5 rounded-xl py-4 px-4 text-slate-900 placeholder:text-slate-400 outline-none transition-all font-mono text-sm"
                                    />
                                </div>
